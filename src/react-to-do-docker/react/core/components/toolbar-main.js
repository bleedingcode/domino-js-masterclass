...
/*
	Toolbar, containing links to open "views" and home page
*/
class ToolbarMain extends React.Component {
	...
	/*
	Generate HTML
	See http://www.material-ui.com/#/components/ for components and https://material.io/icons/ for svg icons
	dataId on each ToolbarMenuItemContainer (toolbar-menu-item-container) controls what displays. The toolbar-menu-item handles calling switchMenu(dataId), so loading the relevant page
	*/
	render(){
